...
namespace Xamarin.Forms.Controls
{
	public class PlatformSpecificsGallery : ContentPage
	{
		...
		public PlatformSpecificsGallery()
		{
			...
			var segmentsButton = new Button { Text = "Segments (Android)" };
			...
			segmentsButton.Clicked += (sender, args) => { Navigation.PushAsync(new SegmentsPageAndroid()); };
			...
			Content = new ScrollView
			{
				Content = new StackLayout
				{
					Children = { mdpiOSButton, mdpWindowsButton, npWindowsButton, tbiOSButton, tbWindowsButton, viselemiOSButton,
						...
						modalformsheetiOSButton, homeIndicatoriOSButton, refreshWindowsButton, segmentsButton }
				}
			};
		}
